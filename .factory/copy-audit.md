...
Counts use whitespace-delimited words and ignore a standalone dash. All
reader-facing landing sentences are at most 22 words. No banned marketing word
appears.
...
Primary action: **Try it with sample data**. It names the sample-data result
and remains visible at 390×844 without scrolling.

## Demo and product sections
...
The demo exit is **Leave demo and use my records**. The price action is **Buy
unlimited receipts — $29**. Both name their result.

| Concept                          | One reader-facing term |
| -------------------------------- | ---------------------- |
| Isolated try-out                 | demo                   |
| Records inside it                | demo records           |
| Receipt input                    | receipt photos         |
...
The decorative “Plate 01” label is removed. Framework and protocol terms stay
only in developer sections where required to run or deploy the project.
